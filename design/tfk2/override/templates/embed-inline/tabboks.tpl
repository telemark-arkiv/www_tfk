{def $tabnode=fetch( 'content', 'node', hash( 'node_id', $object.main_node_id ) )}
{def $tabs=fetch( 'content', 'list', hash( 'parent_node_id', $tabnode.node_id,
                                           'sort_by', $tabnode.sort_array, ) )}
