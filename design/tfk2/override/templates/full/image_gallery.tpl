...
<div class="text-holder">
    ...
    <div class="class-image">
        <div class="visual-inner">
            <div class="visual-holder am-container" id="am-container-{$node.node_id}-{rand()}" data-montage-height="120">
                {foreach $slides as $slide}
                    <div>
                        ...
                        <a title="group2" href="/{$bilde.data_map.image.content.[fullskjerm].full_path}">
                            <img src="/{$bilde.data_map.image.content.[montage].full_path}" alt="{$slide.data_map.name.content}" />
                        </a>
